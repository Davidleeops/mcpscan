...
```text
npm run launch:post-click-verify -- --file /path/to/approved-return-packet.txt --qa-file /path/to/stripe-checkout-qa-evidence.json --apply true --mail-provider {{zoho_or_google_or_spacemail}} --dkim-selector {{dkim_selector}} --strict true
```
...
npm run launch:post-click-verify -- --file /path/to/approved-return-packet.txt --mail-provider {{zoho_or_google_or_spacemail}}
```
...
```text
npm run launch:post-click-verify -- --file /path/to/approved-return-packet.txt --mail-provider {{zoho_or_google_or_spacemail}} --skip-dns true
npm run launch:post-click-verify -- --file /path/to/approved-return-packet.txt --mail-provider {{zoho_or_google_or_spacemail}} --skip-dns true --skip-launch true
```
