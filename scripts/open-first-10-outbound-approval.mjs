...
console.log("Do not send automatically.");
console.log("");
console.log("After live gates and same-turn approval, open the private first-10 send session with:");
console.log("npm run outbound:first-10-session");
console.log("");
console.log("After named-recipient all-10 approval, stage outside the public repo with:");
console.log("npm run outbound:stage-named-first-10 -- --file /path/to/approved-first-10-named-recipient-packet.txt");
console.log("");
...
console.log("");
console.log("After the founder manually sends either approved batch, log it with:");
console.log("npm run outbound:log-first-10-batch -- --batch /path/outside/public/repo/YYYY-MM-DD_first-10-named-approvals");
console.log("npm run outbound:log-first-10-batch -- --batch /path/outside/public/repo/YYYY-MM-DD_first-10-route-approvals");
