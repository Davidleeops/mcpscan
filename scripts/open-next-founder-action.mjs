...
console.log("2. Run npm run launch:domain-session if the .xyz cart wins.");
console.log("3. Run npm run launch:domain-session -- --domain mcpscan.online --mail-provider spacemail if the near-dollar .online cart wins.");
...
console.log("12. Run npm run launch:publish-pages-fallback -- --wait true after approved values are applied.");
console.log("13. Run npm run launch:full-proof -- --live true with the generated evidence files.");
console.log("14. Run npm run launch:public-session before any public post.");
console.log("15. Run npm run outbound:open-send-gates before any outreach.");
console.log("16. Run npm run outbound:open-reply-close after any prospect reply.");
console.log("17. Run npm run delivery:open-handoff after payment clears.");
console.log("18. Run npm run launch:actions-session to clear the GitHub Actions billing lock and rerun CI.");
