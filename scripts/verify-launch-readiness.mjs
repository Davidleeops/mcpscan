...
const requiredFiles = [
  ...
  "scripts/simulate-founder-click-session.mjs",
...
if (exists("scripts/create-paid-audit-handoff.mjs") && exists("ops/paid-audit-handoff-builder.html") && exists("docs/PAYMENT_TO_DELIVERY_SOP.md")) {
  const paidDelivery = [
    ...
    read("scripts/open-paid-audit-delivery-session.mjs"),
    read("scripts/simulate-paid-audit-delivery-session.mjs"),
