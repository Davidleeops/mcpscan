...
const gates = [
  ...
  gate("Generated cheap packets", exists("ops/generated-launch-packets/README.md") && exists("ops/generated-launch-packets/2026-08-14_mcpscan-online_dns-packet.md") && exists("ops/generated-launch-packets/2026-08-14_mcpscan-online_stripe-setup-packet.md") && exists("ops/generated-launch-packets/2026-08-14_mcpscan-online_dns-records.csv") && exists("ops/generated-launch-packets/2026-08-14_mcpscan-online_stripe-products.csv"), "default mcpscan.online DNS, Stripe, and CSV copy-paste payloads are prebuilt"),
