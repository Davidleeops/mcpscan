...
const gates = [
  ...
  gate("Cheap launch packet prep", exists("scripts/prepare-cheap-launch-packets.mjs"), "npm run launch:prepare-cheap builds DNS, Stripe, and CSV copy-paste payloads for mcpscan.site with the selected mail provider"),
