...
const gates = [
  ...
  gate("Payment evidence verifier", exists("scripts/verify-payment-evidence.mjs") && exists("sales/payment-confirmation-evidence.template.json"), "npm run delivery:verify-payment verifies paid status without storing Stripe secrets"),
