...
const gates = [
  ...
  gate("Cheap launch packet prep", exists("scripts/prepare-cheap-launch-packets.mjs"), "npm run launch:prepare-cheap builds DNS and Stripe packets for mcpscan.site"),
  gate("Generated cheap packets", exists("ops/generated-launch-packets/README.md"), "default mcpscan.site DNS and Stripe packets are prebuilt"),
