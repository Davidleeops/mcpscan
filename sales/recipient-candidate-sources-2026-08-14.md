# MCPScan Recipient Candidate Sources

Generated: 2026-08-14

Status: research only. This file does not approve or send outreach.

## Rule

Use these candidates only for same-turn founder approval. Do not send outreach until the exact recipient, exact channel, exact source URL, and exact final message are approved together.

## Public Candidate Rationale

| Account | Candidate | Why This Candidate | Confidence | Public Signal |
| --- | --- | --- | --- | --- |
| Vapi | Nikhil Gupta, Founder and CTO | Public profile connects Gupta to Vapi technical leadership, and Vapi has an MCP server page. | High | https://docs.vapi.ai/sdk/mcp-server |
| Retool | David Hsu, Co-founder and CEO | Official company leadership route is credible for governance and MCP product risk if no product-security owner is approved. | Medium | https://retool.com/blog/retool-mcp-server |
...
| Replit | Ertan Dogrultan, Platform Engineering Lead | Public profile connects Dogrultan to Replit platform engineering. Use founder fallback only if approved. | Medium | https://docs.replit.com/build/connect-via-mcp |
