# MCPScan DNS Packet For mcpscan.site
...
| TXT | _dmarc | v=DMARC1; p=none; rua=mailto:security@mcpscan.site |  |
...
```text
npm run launch:verify-dns -- --domain mcpscan.site --mail-provider zoho --update-status
```
