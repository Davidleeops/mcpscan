...
For the day-of-launch sequence:
...
2. Domain and email DNS console
3. Stripe Payment Link console
4. Approved-link command builder: `approved-links-command-builder.html`
5. Pipeline console, prospect sourcing console, outbound approval console, discovery console, and customer comms console
6. npm publish console
7. Paid-audit delivery console
8. Verification console: `verification-console.html`
9. Cost and infrastructure plan: `docs/LAUNCH_COST_AND_INFRASTRUCTURE_PLAN_2026-08-14.md`
10. Daily revenue command: `sales/daily-revenue-command.md`
11. Reply-to-close packet: `sales/reply-to-close-packet.md`
12. Public-safe founder status tracker: `ops/founder-approval-status.template.json`
